...
Usage:
    python gen_archimedean_spiral.py
    → produces spiral_output.txt (a complete TEXTMAP)
...
b = 20.0                  # Growth rate: r = b * theta (map units per radian)
number_of_loops = 3       # How many full 360-degree revolutions
thickness = 60.0          # Radial width of the spiral arm (map units)
...
def generate():
    ...
    with open(output_file, 'w') as f:
        ...
        # --- Header comment ---
        f.write(f"\n// ===========================================================\n")
        f.write(f"// ARCHIMEDEAN SPIRAL: r = {b} * theta\n")
