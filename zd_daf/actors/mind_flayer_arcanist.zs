...
class MindFlayerArcanist : Actor
{
	Default
	{
		...
		Obituary "%o's mind was shredded by a Mind Flayer Arcanist.";
		HitObituary "%o's brain was magically devoured by a Mind Flayer Arcanist.";
	...
	Missile:
		...
		CUTH K 1 A_SpawnProjectile("MindFlayerArcanistBigBall", 42, 15, angle = random(-30,30));
		CUTH J 0 A_FaceTarget;
		CUTH K 1 A_SpawnProjectile("MindFlayerArcanistBall", 42, 15, angle = random(-30,30));
		CUTH J 0 A_FaceTarget;
		CUTH K 1 A_SpawnProjectile("MindFlayerArcanistBall", 42, 15, angle = random(-30,30));
		CUTH J 0 A_FaceTarget;
		CUTH K 1 A_SpawnProjectile("MindFlayerArcanistBall", 42, 15, angle = random(-30,30));
	...
	Pain:
		CUTH L 0 A_TakeInventory("MindFlayerArcanistInviso", 255);
...
class MindFlayerArcanistBall : Actor
{
	Default
	{
		Radius 13;
...
class MindFlayerArcanistBigBall : Actor
{
	Default
	{
		Radius 26;
...
class MindFlayerArcanistInviso : Inventory
{
	Default
	{
		Inventory.Amount 0;
